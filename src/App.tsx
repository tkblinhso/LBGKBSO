...
export function App() {
  ...
  const handleSyncCurriculum = () => {
    refreshScheduleAndPlans(masterTimetable, schoolInfo);
    setSyncNotification(
      `Đã đồng bộ chuẩn xác 100% Lịch Báo Giảng và Kế Hoạch Bài Dạy theo đúng KHDH SGK Tuần ${schoolInfo.week} (Lớp ${schoolInfo.className})!`
    );
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-5">
        ...
        <div className="mb-6 p-3.5 bg-white border-2 border-black shadow-[3px_3px_0px_rgba(0,0,0,1)] flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center flex-wrap gap-2">
            ...
            <button
              id="btn-sync-curriculum"
              onClick={handleSyncCurriculum}
              className="flex items-center gap-1.5 px-3 py-1.5 bg-emerald-700 hover:bg-emerald-800 text-white text-[11px] font-bold uppercase tracking-wider border border-black shadow-[1px_1px_0px_rgba(0,0,0,1)] transition-colors cursor-pointer"
              title="Đồng bộ tự động tên bài dạy trong LBG và chi tiết hoạt động SGK trong KHBD theo chuẩn KHDH"
            >
              <RefreshCw className="w-3.5 h-3.5" />
              <span>Đồng Bộ KHDH Chuẩn</span>
            </button>
        ...
        {syncNotification && (
          <div className="mb-4 p-3 bg-emerald-50 border-2 border-emerald-600 text-emerald-950 text-xs font-bold flex items-center justify-between shadow-[2px_2px_0px_rgba(5,150,105,0.3)] animate-in fade-in slide-in-from-top-2">
            <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="text-emerald-800 hover:text-black text-xs font-mono font-bold px-2 py-0.5"
            >
              ✕
            </button>
          </div>
